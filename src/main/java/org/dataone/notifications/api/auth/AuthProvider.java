...
public interface AuthProvider {
     ...
     * already been authenticated  you MUST call the
     * {@code authenticate} method before calling this method.
     *
     * @param subject the subject of the user
     * @param pids a List of pids, identifying the resources to which the user wishes to subscribe
